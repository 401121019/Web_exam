...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav center-nav mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link" href="/project/post">Posts</a></li>
          <li class="nav-item"><a class="nav-link" href="/project/dashboard">Dashboard</a></li>
        </ul>

        <!-- Login/Register Buttons -->
        <div class="d-flex">
          <a href="/project/login" class="btn btn-outline-primary me-2">Login</a>
          <a href="/project/register" class="btn btn-primary">Register</a>
        </div>
  ...
  <main>
    <div class="container error-container">
      ...
      <a href="/project/" class="btn btn-danger px-4 py-2"><i class="fas fa-arrow-left me-2"></i>Back to Home</a>
    </div>
  </main>
  ...
  <footer class="py-4">
    <div class="container text-center">
      <p class="mb-2">&copy; 2025 Myproject. All rights reserved.</p>
      <div>
