    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-7">
        ...
        <div class="text-center mt-4">
          <a href="/project/post" class="btn btn-outline-secondary px-4">
...
document.querySelector('.btn').addEventListener('mouseover', function() {
    this.style.backgroundColor = '#e3c628 !important';
    this.style.color = '#1f3de2 !important';
});

document.querySelector('.btn').addEventListener('mouseout', function() {
    this.style.backgroundColor = 'transparent !important';
    this.style.color = '#e3c628 !important';
});
</script>
